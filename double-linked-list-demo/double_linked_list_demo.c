 ...
 * with linked list.
 *    1. Display double linked list data
...
struct node{
    ...
    struct node *prev;  /* Hold the structure pointer of previous node */
...
void print_menu(){
    printf("-----------------------------------------------------------\n");
    printf(" Double Linked List Operation Menu\n");
    printf("-----------------------------------------------------------\n");
    printf(" 1. Display double linked list data\n");
...
int main(){
    ...
    /* menu operation */
    while(1){
	/* Display double linked list operation menu */
	print_menu();
